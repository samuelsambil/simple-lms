    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/5 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          <Link to="/" className="text-3xl font-bold tracking-tight text-white flex items-center gap-2 hover:scale-105 transition-transform duration-300">
        ...
        <section className="text-center max-w-5xl mx-auto mb-20">
          ...
          <div className="relative max-w-3xl mx-auto group">
            ...
            <div className="relative">
              <span className="absolute left-7 top-1/2 -translate-y-1/2 text-2xl pointer-events-none">
                🔍
              </span>
              <input
                type="text"
                ...
                className="w-full pl-16 pr-16 py-5 text-lg rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-400 focus:outline-none focus:bg-white/15 transition-all duration-300 shadow-2xl"
              />
              {searchValue && (
                <button
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              {['Python', 'UI/UX Design', 'Data Science', 'Business', 'AI & ML'].map((topic) => (
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-gray-300 text-sm hover:bg-white/10 hover:border-white/20 hover:scale-105 transition-all duration-300 cursor-pointer"
                >
                  {topic}
                </button>
              ))}
